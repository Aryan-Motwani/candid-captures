...
export default function NavbarDark({ open, setOpen }) {
        ...
        <header className="fixed top-0 left-0 right-0 z-10 bg-black">
            <div className="wrapper py-3 flex items-center justify-between text-black" style={{ maxWidth: '92rem' }}>
                ...
                <nav className="hidden lg:flex space-x-6 gap-10">
                    <Link to="/" className="text-black hover:text-gray-300 transition duration-300" style={{"fontSize" : "20px", fontWeight : "bold"}}>
                        Home
                    </Link>
                    <Link to="/portfolio" className="text-black hover:text-gray-300 transition duration-300" style={{"fontSize" : "20px", fontWeight : "bold"}}>
                        Portfolio
                    </Link>
                    <Link to="/about" className="text-black hover:text-gray-300 transition duration-300" style={{"fontSize" : "20px", fontWeight : "bold"}}>
                        About Us
                    </Link>
                    <Link to="/contact" className="text-black hover:text-gray-300 transition duration-300" style={{"fontSize" : "20px", fontWeight : "bold"}}>
                        Contact
                    </Link>
                </nav>
