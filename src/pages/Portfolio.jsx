...
export default function Portfolio() {
  ...
  // const filterCategories = ["wedding", "fashion", "portrait", "prom", "studio"];
          ...
          <div className="wrapper min-h-screen pt-[120px] pb-[50px] md:pt-[170px] md:pb-[100px]">
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-12"
              ...
              >
                {filteredImages.map((img, index) => (
                  <div
                  className="overflow-hidden aspect-[16/9] cursor-pointer group"
                  ...
                  >
                    <img
                      ...
                      src={img.path}
                      alt=""
                      className="group-hover:scale-125 duration-500 w-full h-full object-cover"
                    />
                  </div>
                ))}
              </motion.div>
